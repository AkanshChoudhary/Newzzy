    ...
    Box(modifier = modifier) {
        TextField(
            ...
            colors = TextFieldDefaults.colors( // Changed from textFieldColors to colors
                focusedContainerColor = colorResource(id = R.color.input_background), // Material 3 uses more specific color roles
                ...
                // Material 3 uses focusedTextColor, unfocusedTextColor, etc.
                // For a single text color for all states, you might not need to set it explicitly
                // if the default behavior is acceptable or if you are handling it via textStyle.
